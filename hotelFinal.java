...
public class hotelFinal {
    ...
    static boolean[] kamarTersedia = { true, true, true }; // array ketersediaan kamar dengan kondisi awal true
                                                           // (tersedia)

    // Deklarasi dan Inisialisasi array daftar kamar berbahasa Indonesia (sample
    ...
    // Deklarasi dan Inisialisasi array daftar kamar berbahasa Inggris (sample data,
    // sesuai kebutuhan)
    static String[][] daftarKamarEng = {
            { "Standard", "IDR. 500.000,00 / Night", "2x Single Bed, 1x TV, 1x Fan, Toiletries" },
            { "Superior", "IDR. 1.000.000,00 / Night",
                    "1x Double Bed 1x AC 1x TV 24 inch Toiletries Morning Meal & Drinks" },
            { "Deluxe", "IDR. 1.500.000,00 / Night",
                    "1x Queen Bed 2x AC 1x TV 48 inch Toiletries Eat & Drink 3x Daily + Snack" },
    };
                            ...
                            if (menu >= 1 && menu <= kelasKamar.length) {
                                ...
                                if (kamarTersedia[menu - 1]) {
                                    ...
                                    System.out.println(
                                            "|====================================================================================|");
                                    System.out.println(
                                            "|                       KAMAR SUDAH TERISI, PILIH KAMAR LAIN!                        |");
                                    System.out.println(
                                            "|====================================================================================|");
                                    System.out.println();
                                }
                    ...
                    for (int i = 0; i < namaTamu.length; i++) {
                        if (namaTamu[i] != null && namaTamu[i].equalsIgnoreCase(namaReschedule)) {
                            ...
                            System.out.println(
                                    "|====================================================================================|");
                            System.out
                                    .println("| Reschedule berhasil untuk tamu dengan nama " + namaReschedule + "!  |");
                            System.out.println(
                                    "|====================================================================================|");
                            System.out.println();
                        ...
                        for (int i = 0; i < namaTamu.length; i++) {
                            ...
                            if (namaTamu[i] != null && namaTamu[i].equalsIgnoreCase(namaCheckout)) {
                                ...
                                System.out.println(
                                        "|====================================================================================|");
                                System.out.println(
                                        "| Checkout berhasil untuk tamu dengan nama " + namaCheckout + "!   |");
                                System.out.println(
                                        "|====================================================================================|");
                                System.out.println();
    ...
    static void mainenglish() {
        ...
        while (true) {
            ...
            System.out
                    .println("|====================================================================================|");
            System.out
                    .println("| 1. Room Price List                                                                 |");
            System.out
                    .println("| 2. Check Room Availability                                                         |");
            System.out
                    .println("| 3. Guest List                                                                      |");
            System.out
                    .println("| 4. Check-In                                                                        |");
            System.out
                    .println("| 5. Reschedule                                                                      |");
                            ...
                            if (menu >= 1 && menu <= kelasKamar.length) {
                                ...
                                if (kamarTersedia[menu - 1]) {
                                    ...
                                    System.out.println(
                                            "===========================================================================================|");
                                    System.out.println(
                                            "| Guest " + nama + " have staying for " + lama_menginap + " Nights, ");
                                    ...
                                    System.out.println(
                                            "| *THE HOTEL IS NOT RESPONSIBLE FOR ANY LOSSES !!!                                         |");
                                    System.out.println(
                                            "============================================================================================");
                                    System.out.println();
                                } else {
                                    ...
                                    System.out.println(
                                            "|====================================================================================|");
                                    System.out.println(
                                            "|                       ROOM OCCUPIED, CHOOSE ANOTHER ROOM !                         |");
                                    System.out.println(
                                            "|====================================================================================|");
                                    System.out.println();
                                }
    ...
    // anyaran
    // Fungsi laporanHarian
    static void laporanHarianEng(String[] namaTamu, String[] asalTamu, int[] usiaTamu,
            String[] jenisKelamin, int[] lamaMenginapTamu,
            String[] tanggalBook, long[] totalPembayaran) {
        System.out.println("titiktitiktitiktitiktitiktitiktitiktitikttiktitiktikti");
        System.out.println("|          IN LPRN OK mwuacchhhhhhhhhhhhhhhhh        |");
